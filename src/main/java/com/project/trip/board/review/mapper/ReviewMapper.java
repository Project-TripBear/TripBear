...
/**
 * 여행 후기 게시판과 관련된 데이터베이스 연동을 위한 매퍼 인터페이스입니다.
 * <p>
...
public interface ReviewMapper {
    ...
    /**
     * 전체 리뷰 게시글의 수를 조회합니다.
     * 페이징 처리를 위한 조건을 포함하는 맵을 매개변수로 받습니다.
     *
    ...
    /**
     * 특정 리뷰 게시글에 연결된 모든 댓글을 삭제합니다.
     *
     * @param reviewPostId 댓글을 삭제할 리뷰 게시글의 고유 번호
     */
	void deleteAllComments(int reviewPostId);

    /**
     * 특정 리뷰 게시글에 연결된 모든 스크랩 정보를 삭제합니다.
     *
     * @param reviewPostId 스크랩 정보를 삭제할 리뷰 게시글의 고유 번호
     */
