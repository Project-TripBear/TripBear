<%-- /WEB-INF/views/content/find/add.jsp (클린 코드) --%>
...
<div class="notice-form-container">
    ...
    <form action="<c:url value="/findboard/add"/>" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="find_board_title" class="form-control" required>
        </div>
        ...
        <%-- 파일 업로드 필드 --%>
        <div class="form-group">
            <label for="attachFile">대표 이미지 첨부</label>
